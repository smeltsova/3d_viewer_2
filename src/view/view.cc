...
void s21::MainWindow::on_horizontalScrollBar_translate_x_valueChanged(int value)
{
  ui->doubleSpinBox_translate_x->setValue(value / 10.0);
}

void s21::MainWindow::on_horizontalScrollBar_translate_y_valueChanged(int value)
{
  ui->doubleSpinBox_translate_y->setValue(value / 10.0);
}

void s21::MainWindow::on_horizontalScrollBar_translate_z_valueChanged(int value)
{
...
void s21::MainWindow::setXScale(const QString &scale)
{
  ...
  if (new_scale != 0)
  {
    controller_.scale(ui->widget->obj, new_scale / ui->widget->getXScale(), 1, 1);
...
void s21::MainWindow::setYScale(const QString &scale)
{
  ...
  if (new_scale != 0)
  {
    controller_.scale(ui->widget->obj, 1, new_scale / ui->widget->getYScale(), 1);
...
void s21::MainWindow::setZScale(const QString &scale)
{
  ...
  if (new_scale != 0)
  {
    controller_.scale(ui->widget->obj, 1, 1, new_scale / ui->widget->getZScale());
