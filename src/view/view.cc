...
//   float new_deg = deg.toFloat();
//   trObject->rotation.transform(obj, new_deg - yRot, 'y');
//   yRot = new_deg;
//   update();
// }
...
//   float new_deg = deg.toFloat();
//   trObject->rotation.transform(obj, new_deg - zRot, 'z');
//   zRot = new_deg;
//   update();
// }
...
//   if (new_scale != 0) {
//     trObject->scaling.transform(obj, new_scale / xScale, 1, 1);
//     xScale = new_scale;
//     update();
//   }
// }
...
//   float new_scale = scale.toFloat();
//   if (new_scale != 0) {
//     trObject->scaling.transform(obj, 1, new_scale / yScale, 1);
//     yScale = new_scale;
//     update();
//   }
// }
...
//   float new_scale = scale.toFloat();
//   if (new_scale != 0) {
//     trObject->scaling.transform(obj, 1, 1, new_scale / zScale);
//     zScale = new_scale;
//     update();
//   }
// }
