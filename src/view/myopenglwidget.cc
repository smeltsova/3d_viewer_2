...
s21::MyOpenGLWidget::~MyOpenGLWidget() { obj.clear(); }
...
void s21::MyOpenGLWidget::drawLines() {
  ...
  //                    &a);
  glDrawElements(GL_LINES, obj.edgesArray.size(), GL_UNSIGNED_INT, &arr);
  if (edge_mode == 1) {
...
float s21::MyOpenGLWidget::getDx() { return dx; }

float s21::MyOpenGLWidget::getDy() { return dy; }

float s21::MyOpenGLWidget::getDz() { return dz; }
...
float s21::MyOpenGLWidget::getXRot() { return xRot; }

float s21::MyOpenGLWidget::getYRot() { return yRot; }

float s21::MyOpenGLWidget::getZRot() { return zRot; }
...
float s21::MyOpenGLWidget::getXScale() { return xScale; }

float s21::MyOpenGLWidget::getYScale() { return yScale; }

float s21::MyOpenGLWidget::getZScale() { return zScale; }